...
?>
    ...
    <head>
        ...
        <meta property="og:url" content="https://devlan.co.ke">
        <meta property="og:title" content="<?php echo $sys->system_name; ?>">
        <meta property="og:description" content="E Learning Management System">
        <meta property="og:image" content="../public/images/<?php echo $sys->system_logo; ?>">

        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="https://devlan.co.ke">
        <meta property="twitter:title" content="<?php echo $sys->system_name; ?>">
        <meta property="twitter:description" content="E Learning Management System">
        <meta property="twitter:image" content="../public/images/<?php echo $sys->system_logo; ?>">

        <!-- Favicons -->
        <link rel="apple-touch-icon" sizes="180x180" href="../public/images/<?php echo $sys->system_logo; ?>">
        <link rel="icon" type="image/png" sizes="32x32" href="../public/images/<?php echo $sys->system_logo; ?>">
        <link rel="icon" type="image/png" sizes="16x16" href="../public/images/<?php echo $sys->system_logo; ?>">
