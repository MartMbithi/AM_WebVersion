...
?>
    <div class="sidenav-wrapper" id="sidenavWrapper">
        ...
        <div class="sidenav-profile">
            ...
            <!-- User Thumbnail-->
            <div class="user-profile"><img src="<?php echo $url; ?>" alt=""></div>
            <!-- User Info-->
            <div class="user-info">
                <h6 class="user-name mb-0"><?php echo $logged_in_user->user_number; ?></h6><span><?php echo $logged_in_user->user_name; ?></span>
            </div>
        </div>
        <!-- Sidenav Nav-->
        ...
        <div class="copyright-info">
            <p>Copyright &copy; 2020 - <?php echo date('Y') . "<br>" . $logged_in_user->system_name; ?>.</p>
        </div>
    </div>
<?php } ?>