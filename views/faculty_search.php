                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Advanced Search Faculties</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Search Faculties</h4>
                        </div>
                        <!--end page-title-box-->
                            ...
                            <div class="card-body">
                                <div class="">
                                    <fieldset class="border border-primary p-2">
                                        <legend class="w-auto text-primary font-weight-light">Enter Faculty Name Or Code</legend>
                                ...
                                <fieldset class="border border-primary p-2">
                                    ...
                                    if (strlen($query) >= $min_length) {
                                        ...
                                        $raw_results = mysqli_query(
                                            $mysqli,
                                            "SELECT *   FROM  faculties f INNER JOIN users u ON u.user_id = f.faculty_user_id
                                        WHERE (`faculty_code` LIKE '%" . $query . "%') || (`faculty_name` LIKE '%" . $query . "%')"
                                        );
                                        if (mysqli_num_rows($raw_results) > 0) {
                                            while ($results = mysqli_fetch_array($raw_results)) {
                                    ?>
                                                <div class="card col-md-12 col-xl-12 col-lg-12 col-sm-12">
                                                    <a href="faculty_dashboard?view=<?php echo $results["faculty_id"]; ?>">
                                                        <div class="row g-0">
                                                            <div class="col-md-6">
                                                                <img src="../public/images/icons/university.png" class="img-thumbnail img-fluid rounded-start" alt="...">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <h5 class="card-title"><?php echo $results["faculty_code"] . ' ' . $results["faculty_name"]; ?></h5>
                                                                    <p class="card-text">
                                                                        <?php echo $results["faculty_details"]; ?>
                                                                    </p>
