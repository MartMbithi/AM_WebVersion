...
JOIN academic_calendar JOIN faculties 
...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->faculty_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Overall Timetable.  Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <h4>' . $sys->faculty_name . ' / ' . $sys->calendar_year . ' Overall  Timetable </h4>
            </h3>
            ...
            while ($tt = $res->fetch_object()) {
                $html .=
                    '
                        <tr>
                            <td>' . $tt->module_code . '  ' . $tt->module_name . '</td>
                            <td>' . $tt->user_number . '  ' . $tt->user_name . '</td>
                            <td>' . $tt->timetable_class_room . '</td>
                            <td>' . $tt->timetable_class_day . '</td>
                            <td>' . $tt->timetable_class_start_time . '  To  ' . $tt->timetable_class_end_time . '</td>
                        </tr>
                        ';
                }
                $html .= '
    ...
    $dompdf->render();
    $dompdf->stream($sys->faculty_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Overall School Timetable', array("Attachment" => 1));
