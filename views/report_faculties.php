                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-right">
                            <a href="report_faculty_export_xls" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export To Excel</a>
                            <a href="report_faculty_export_pdf" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export To PDF</a>
