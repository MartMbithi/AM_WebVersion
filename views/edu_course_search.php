                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Advanced Search Courses</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Search Courses</h4>
                        </div>
                        <!--end page-title-box-->
                            ...
                            <div class="card-body">
                                <div class="">
                                    <fieldset class="border border-primary p-2">
                                        <legend class="w-auto text-primary font-weight-light">Enter Course Name Or Code</legend>
                                ...
                                <fieldset class="border border-primary p-2">
                                    ...
                                    if (strlen($query) >= $min_length) {
                                        ...
                                        $raw_results = mysqli_query(
                                            $mysqli,
                                            "SELECT * FROM courses c INNER JOIN departments d ON d.department_id = c.course_id
                                            WHERE (`course_code` LIKE '%" . $query . "%') || (`course_name` LIKE '%" . $query . "%')  
                                            "
                                        );
                                    ...
                                    ?>
                                                ...
                                                <div class="card col-md-12 col-xl-12 col-lg-12 col-sm-12">
                                                    <a href="course_dashboard?view=<?php echo $results["course_id"]; ?>">
                                                        <div class="row g-0">
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <h5 class="card-title"><?php echo $results['course_code'] . ' ' . $results['course_name']; ?></h5>
                                                                    <h5 class="card-title">Department Details : <?php echo $results['department_code'] . ' ' . $results['department_name']; ?></h5>

                                                                    <p class="card-text">
                                                                        <?php echo $results['course_details']; ?>
                                                                    </p>
