                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Advanced Search Administrators</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Search Administrators</h4>
                        </div>
                        <!--end page-title-box-->
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label>Staff Number Or Name</label>
                                    ...
                                    <div class="row">
                                        ...
                                        if (strlen($query) >= $min_length) {
                                            ...
                                            $raw_results = mysqli_query(
                                                $mysqli,
                                                "SELECT *   FROM users 
                                            WHERE (`user_number` LIKE '%" . $query . "%') || (`user_name` LIKE '%" . $query . "%')   
                                            "
                                            );
                                        ...
                                        ?>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="admin_profile?view=<?php echo $results['user_id']; ?>">
