            ...
            <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-8 align-self-center text-right">
                                            <div class="ml-2">
                                                <p class="mb-1 text-muted">Allocated Modules</p>
                                                <h3 class="mt-0 mb-1 font-weight-semibold"><?php echo $current_allocations; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-8 align-self-center text-right">
                                            <div class="ml-2">
                                                <p class="mb-1 text-muted">Enrolled Students</p>
                                                <h3 class="mt-0 mb-1 font-weight-semibold"><?php echo $enrolled_students; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mt-0 mb-3">My <?php echo $_SESSION['current_calendar']; ?> Teaching Time Table</h4>
