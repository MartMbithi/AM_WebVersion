                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Departmental Documents</li>
                                </ol>
                            </div>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select name="doc_dep_id" style="width: 100%;" required class="basic form-control">
                                                <?php
                    ...
                    <div class="col-lg-12">
                        <div class="">
                            <fieldset class="border border-primary p-2">
                                <legend class="w-auto text-primary font-weight-light">Select Any Department To View Its Posted Departmental Documents </legend>
                                <div class="row">
                                    <?php
                                    /* Pop All Departments In Asc Order */
                                    ...
                                    $res = $stmt->get_result();
                                    while ($departments = $res->fetch_object()) {
                                        /* Give A Count On Posted Notices */
                                        $department_id = $departments->department_id;
                                        include('../helpers/department_documents_count.php');
                                    ?>
                                        <div class="col-md-4">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center my-4">
                                                        <div>
                                                            ...
                                                            <p class="header-title">Posted Documents : <span class="text-primary"><?php echo $no_of_posted_docs; ?></span></p><br>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            ?>
                                <fieldset class="border border-primary p-2">
                                    <legend class="w-auto text-primary font-weight-light">Departmental Documents Under : <?php echo $_POST['DepartmentCode'] . ' ' . $_POST['DepartmentName']; ?></legend>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        WHERE dd.doc_dep_id  = '$department_id'";
                                                        $stmt = $mysqli->prepare($ret);
                                                        $stmt->execute(); //ok
                                                        $res = $stmt->get_result();
