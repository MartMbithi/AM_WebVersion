...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->system_name . '  Administrators List Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            while ($admins = $res->fetch_object()) {
                if($admins->user_access_level == 'sys_admin'){
                    $level = "System Administrator";
                }else{
                    $level = "Educational Administrator";
                }
                $html .=
            '
                <tr>
    ...
    $dompdf->render();
    $dompdf->stream($sys->system_name . ' Adminstrators ', array("Attachment" => 1));
