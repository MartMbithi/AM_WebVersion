...
while ($sys = $res->fetch_object()) {
    ...
    /* Excel File Name */
    $fileName = $sys->faculty_name . "  " . $sys->calendar_year . ' ' . $sys->calendar_semester . " Student Module Enrollments.xls";

    /* Excel Column Name */
    $header = array($sys->faculty_name . ' ' . $sys->calendar_year  . ' ' . $sys->calendar_semester . ' Student Module Enrollments');
