                        ...
                        <div class="col-lg-12">
                            <div class="">
                                <fieldset class="border border-primary p-2">
                                    <legend class="w-auto text-primary font-weight-light">Select Academic Year And Semester To Manage Allocations</legend>
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-row">
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            WHERE ac.calendar_id = '$calendar_id' 
                                                            AND m.module_course_id = '$view'";
                                                            $stmt = $mysqli->prepare($ret);
                                                            $stmt->execute(); //ok
                                                            $res = $stmt->get_result();
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $allocations->calendar_year . ' - ' . $allocations->calendar_semester . ' ' . $allocations->calendar_status; ?></td>
                                                                    <td>
