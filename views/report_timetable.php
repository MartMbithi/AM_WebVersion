                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Overall School Timetable</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                            ...
                            <div class="col-lg-12">
                                ...
                                ?>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-right">
                                                <a href="report_timetable_export_xls?session=<?php echo $_POST['allocation_calendar_id']; ?>" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export To Excel</a>
                                                <a href="report_timetable_export_pdf?session=<?php echo $_POST['allocation_calendar_id']; ?>" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                            </div>
                                            <br>
                                            <div class="">
