...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->faculty_name . ' Registered Departments List Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <h4> ' . $sys->faculty_name . '  Departments List </h4>
            </h3>
        ...
        $html .=
            '
                    <tr>
                        ...
                        <td>' . $departments->user_number . '  ' . $departments->user_name . '</td>
                    </tr>
                    ';
    }
    $html .= '
    ...
    $dompdf->render();
    $dompdf->stream($sys->faculty_name . ' Departments ', array("Attachment" => 1));
