                            ...
                            <div class="col-lg-12">
                                ...
                                ?>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-right">
                                                <a href="report_enrollments_export_xls?session=<?php echo $_POST['allocation_calendar_id']; ?>" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export To Excel</a>
                                                <a href="report_enrollments_export_pdf?session=<?php echo $_POST['allocation_calendar_id']; ?>" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                            </div>
                                            <br>
                                            <div class="">
