                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-right">
                            <a href="report_all_courses_export_xls" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export All Courses To Excel</a>
                            <a href="report_all_courses_export_pdf" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export All Courses To PDF</a>
                        </div>
                        <hr>
                        <fieldset class="border border-primary p-2">
                            <legend class="w-auto text-primary font-weight-light">Select Department Code & Name To Get Registered Courses</legend>
                            <form method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <select name="department_id" style="width: 100%;" required class="basic form-control">
                                            ...
                                            ?>
                                                <option value="<?php echo $dep->department_id; ?>"><?php echo $dep->department_code . ' - ' . $dep->department_name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        ?>
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-right">
                                        <a href="report_courses_export_xls?department=<?php echo $_POST['department_id']; ?>" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export Courses To Excel</a>
                                        <a href="report_course_export_pdf?department=<?php echo $_POST['department_id']; ?>" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export Courses To PDF</a>
                                    </div>
                                    <br>
                                    <div class="">
