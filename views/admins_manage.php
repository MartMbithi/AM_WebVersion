                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Manage Administrators</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($users->user_access_level == 'sys_admin') { ?>
                                                            <span class="badge badge-danger">System Admin</span>
                                                        <?php } else if ($users->user_access_level == 'educational_admin') { ?>
                                                            <span class="badge badge-primary">Educational Admin</span>
                                                        <?php } ?>
                                                    </td>
                                                    <td>
                                                        <a href="admin_profile?view=<?php echo $users->user_id; ?>" class="badge badge-success"><i class="fas fa-eye"></i> View</a>
