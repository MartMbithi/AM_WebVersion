        ...
        <div class="page-content-tab">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Howdy, <?php echo $_SESSION['user_name'] ?>, Welcome Back</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                ...
                <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-10 align-self-center text-right">
                                            <div class="ml-2">
                                                <p class="mb-1 text-muted">Current Academic Calendar</p>
                                                <h3 class="mt-0 mb-1 font-weight-semibold"><?php echo $current_academic_year; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <a href="my_previous_enrollments">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-4 align-self-center">
                                            <div class="icon-info">
                                                <i class="fas fa-boxes align-self-center icon-lg icon-dual-purple"></i>
                                            </div>
                                        </div>
                                        <div class="col-8 align-self-center text-right">
                                            <div class="ml-2">
                                                <p class="mb-1 text-muted">Previously Enrolled Modules</p>
                                                <h3 class="mt-0 mb-1 font-weight-semibold"><?php echo $past_enrolled_modules; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <a href="my_current_enrollments">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-4 align-self-center">
                                            <div class="icon-info">
                                                <i class="fas fa-user-graduate align-self-center icon-lg icon-dual-success"></i>
                                            </div>
                                        </div>
                                        <div class="col-8 align-self-center text-right">
                                            <div class="ml-2">
                                                <p class="mb-1 text-muted">Currently Enrolled Modules</p>
                                                <h3 class="mt-0 mb-1 font-weight-semibold"><?php echo $currently_enrolled_modules; ?></h3>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mt-0 mb-3"><?php echo $_SESSION['current_calendar']; ?> Time Table</h4>
                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        INNER JOIN enrollments e ON e.enrollment_module_id = m.module_id 
                                        ...
                                        WHERE e.enrollment_user_id = '$user_id' AND ac.calendar_status = 'Current'";
