...
if (isset($_POST['add_department'])) {
    $department_faculty_id = $_GET['view'];
                                    ...
                                    <div class="">
                                        <form method="post" enctype="multipart/form-data" role="form">
                                            <fieldset class="border border-primary p-2">
                                                <legend class="w-auto text-primary font-weight-bold">Register New Department Under <?php echo $faculty->faculty_name; ?> Faculty</legend>
                                                <div class="card-body">
                                                    <div class="row">
