                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Courses Time Table</h4>
                            </div>
                            <!--end page-title-box-->
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="timetable_allocation_id" style="width: 100%;" required class="basic form-control">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $allocation->allocation_id; ?>"><?php echo $allocation->module_code . ' ' . $allocation->module_name . ' Allocate To : ' . $allocation->user_number . ' ' . $allocation->user_name; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
