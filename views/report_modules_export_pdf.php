...
JOIN courses WHERE course_id = '$course'";
...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->system_name .' ' . $sys->course_code . ' ' . $sys->course_name . ' Modules  List Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <h4>' . $sys->course_code . ' ' . $sys->course_name . ' Modules </h4>
            </h3>
    ...
    $dompdf->render();
    $dompdf->stream($sys->system_name . ' Modules List ', array("Attachment" => 1));
