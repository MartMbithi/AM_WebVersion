                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Departments Reports</li>
                                    </ol>
                                </div>
                                <h4 class="page-title"><?php echo $faculty->faculty_name; ?> Departments Reports</h4>
                            </div>
                            <!--end page-title-box-->
                        </div>
                        <!--end col-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="text-right">
                                <a href="faculty_report_department_export_xls?view=<?php echo $view; ?>" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export To Excel</a>
                                <a href="faculty_report_department_export_pdf?view=<?php echo $view; ?>" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export To PDF</a>
