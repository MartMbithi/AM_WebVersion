                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="timetable_allocation_id" style="width: 100%;" required class="basic form-control">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $allocation->allocation_id; ?>"><?php echo $allocation->module_code . ' ' . $allocation->module_name . ' Allocated To ' . $allocation->user_number . ' ' . $allocation->user_name; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                <fieldset class="border border-primary p-2">
                                    <legend class="w-auto text-primary font-weight-light">Select Academic Year And Semester To Manage Time Table</legend>
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-row">
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        WHERE ma.allocation_calendar_id = '$calendar_id'
                                                        AND c.course_id = '$view'";
                                                        $stmt = $mysqli->prepare($ret);
                                                        $stmt->execute(); //ok
                                                        $res = $stmt->get_result();
