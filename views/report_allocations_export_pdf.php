...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->system_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Teaching Allocations.  Generated On ' . date('d M Y') . '</i>
            </div>
    ...
    $dompdf->render();
    $dompdf->stream($sys->system_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Teaching Allocations', array("Attachment" => 1));
