                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Departments Reports</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-right">
                            <a href="report_department_export_xls" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export To Excel</a>
                            <a href="report_department_export_pdf" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $departments->faculty_code . ' ' . $departments->faculty_name; ?></td>
