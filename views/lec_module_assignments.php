                        ...
                        <div class="">
                            ...
                            ?>
                                <fieldset class="border border-primary p-2">
                                    ...
                                    INNER JOIN module_allocations mal ON mal.allocation_module_id = m.module_id
                                    INNER JOIN academic_calendar ac ON ac.calendar_id = mal.allocation_calendar_id
                                    WHERE m.module_id = '$module_id' AND ac.calendar_status = 'Current' AND mal.allocation_user_id = '$user_id'
                                            ...
                                            <div class="row g-0">
                                                <div class="col-md-12">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="text-right">
                                                            <a href="lec_module_assignment?view=<?php echo $asn->asn_id; ?>" class="badge badge-primary"><i class="fas fa-eye"></i> View Attempts</a>
