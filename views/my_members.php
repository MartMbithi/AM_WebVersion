            ...
            <div class="page-header-content">
                <div class="page-header-inner">
                    <div class="page-title">
                        <h2>Asian Melodies Members Near Me</h2>
                    </div>
                    <ol class="breadcrumb">
        ...
        <div class="container">
            ...
            <div class="member-wrapper">
                <div class="row g-3 row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 justify-content-center">
                    <?php
                    /* Fetch Members Around Me */
                    $user_city = $_SESSION['user_address'];
                    $user_id = $_SESSION['user_id'];
                    $raw_results = mysqli_query($mysqli, "SELECT * FROM users 
                    WHERE user_id !='{$user_id}' AND user_account_status = 'Verified' AND (`user_address` LIKE '%" . $user_city . "%')  ");
