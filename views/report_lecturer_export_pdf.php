...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->system_name . '  Teaching Staffs List Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            while ($admins = $res->fetch_object()) {
                if($admins->user_access_level == 'lecturer'){
                    $level = "Lecturer - Teaching Staff";
                }
                $html .=
            '
                <tr>
                    <td>' . $admins->user_number . '</td>
                    <td>' . $admins->user_name . '</td>
                    <td>' . $admins->user_phone . '</td>
                    <td>' . $admins->user_email . '</td>
                    <td>' . $admins->user_adr . '</td>
                    <td>' . $level . '</td>
                </tr>
                ';
            }
    ...
    $dompdf->render();
    $dompdf->stream($sys->system_name . ' Lecturers ', array("Attachment" => 1));
