                    ...
                    <div class="col-lg-12">
                        <div class="">
                            <fieldset class="border border-primary p-2">
                                <legend class="w-auto text-primary font-weight-light">Select Any Department To View Its Posted Notices </legend>
                                <div class="row">
                                    <?php
                                    /* Pop All Departments In Asc Order */
                                    ...
                                    while ($departments = $res->fetch_object()) {
                                        ...
                                        include('../helpers/department_notices_count.php');
                                    ?>
                                        <div class="col-md-3">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center my-4">
                                                        <div>
                                                            ...
                                                            <p class="header-title">Posted Notices : <span class="text-primary"><?php echo $no_of_posted_notices; ?></span></p><br>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            ?>
                                <fieldset class="border border-primary p-2">
                                    <legend class="w-auto text-primary font-weight-light">All Posted Notices Under : <?php echo $_POST['DepartmentCode'] . ' ' . $_POST['DepartmentName']; ?></legend>
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
