...
if (isset($_POST['update_module'])) {
    ...
    $prepare->execute();
    if ($prepare) {
        $success = "Module Details Updated";
    } else {
                        ...
                        <div class="col-sm-12">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="module_manage">Modules</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tab-content detail-list" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="email_password">
                                    <div class="row">
                                        <div class="col-lg-12 col-xl-12 mx-auto">
                                            <div class="card">
                                                <div class="card-body">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" value="<?php echo $module->module_code; ?>" name="module_code" required class="form-control">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Module Name</label>
                                                                    <input type="text" name="module_name" value="<?php echo $module->module_name; ?>" required class="form-control">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label>Module Details</label>
                                                                    <textarea type="text" name="module_details" rows="10" required class="summernote form-control"><?php echo $module->module_details; ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
