...
if (isset($_POST['add_allocation'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($prepare && $mail->send()) {
            $success = "Instructor Allocated Module";
        } else {
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Courses Modules Allocations</li>
                                </ol>
                            </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="allocation_user_id" style="width: 100%;" onChange="GetInstructorDetails(this.value);" required class="basic form-control">
                                                ...
                                                WHERE user_access_level ='lecturer'                               
                    ...
                    <div class="col-lg-12">
                        <div class="">
                            <fieldset class="border border-primary p-2">
                                <legend class="w-auto text-primary font-weight-light">Select Teaching Staff & Acadmeic Year / Semester To Manage Allocations</legend>
                                <form method="post" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <select name="user_id" style="width: 100%;" required class="basic form-control">
                                                <option>Select Teaching Staff</option>
                                                <?php
                                                /* Pop All Courses In Asc Order */
                                                $ret = "SELECT * FROM users WHERE user_access_level = 'lecturer'                                 
                                                ORDER BY user_number ASC  ";
                                                $stmt = $mysqli->prepare($ret);
                                                $stmt->execute(); //ok
                                                $res = $stmt->get_result();
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        WHERE u.user_id = '$user_id' AND ac.calendar_id = '$calendar_id'";
                                                        $stmt = $mysqli->prepare($ret);
                                                        $stmt->execute(); //ok
                                                        $res = $stmt->get_result();
                                                                                ...
                                                                                <form method="post" enctype="multipart/form-data">
                                                                                    <div class="form-row">
                                                                                        ...
                                                                                        <div class="form-group col-md-12">
                                                                                            <label>Instructor Number & Name</label>
                                                                                            <select disabled="true" name="allocation_user_id" style="width: 100%;" required class="basic form-control">
