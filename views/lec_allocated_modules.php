                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Allocated Modules</li>
                                </ol>
                            </div>
                            <h4 class="page-title"><?php echo $_SESSION['current_calendar']; ?> Allocated Modules</h4>
                        </div>
                        <hr>
                    </div>
                    <!--end col-->
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                WHERE u.user_id = '$user_id' AND calendar_status ='Current'";
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $allocations->module_code; ?></td>
                                                        <td><?php echo $allocations->module_name; ?></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
