...
if (isset($_POST['add_submission'])) {
    $att_user_id = $_POST['att_user_id'];
    $att_asn_id = $_POST['att_asn_id'];
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="module_assignments">Module Assignments</a></li>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="att_user_id" style="width: 100%;" required class="basic form-control">
                                                    <?php
                                                    /* Pop All Courses In Asc Order */
                                                    $ret = "SELECT * FROM enrollments e
                                                    INNER JOIN users u ON u.user_id = e.enrollment_user_id";
                                                    $stmt = $mysqli->prepare($ret);
                                                    $stmt->execute(); //ok
                                                    $res = $stmt->get_result();
                                                    while ($enrollments = $res->fetch_object()) {
                                                    ?>
                                                        <option value="<?php echo $enrollments->user_id; ?>"><?php echo $enrollments->user_number . ' - ' . $enrollments->user_name; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <!-- Hide this -->
                                                <input type="hidden" name="att_asn_id" value="<?php echo $view; ?>">
                                            </div>
                                            <div class="form-group col-md-6">
