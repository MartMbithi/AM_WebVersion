                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="enrollment_module_id" style="width: 100%;" onChange="GetModuleDetails(this.value);" required class="basic form-control">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $allocation->module_id; ?>"><?php echo $allocation->module_code . ' ' . $allocation->module_name . ' Allocated To ' . $allocation->user_number . ' ' . $allocation->user_name; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <!-- Hide This  -->
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                <fieldset class="border border-primary p-2">
                                    <legend class="w-auto text-primary font-weight-light">Select Academic Year And Semester To Manage Enrollments</legend>
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <select name="calendar_id" style="width: 100%;" required class="basic form-control">
                                                    <option>Select Academic Year And Semester</option>
                                                    <?php
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        WHERE m.module_course_id = '$view'
                                                        AND ac.calendar_id = '$calendar_id'";
                                                        $stmt = $mysqli->prepare($ret);
                                                        $stmt->execute(); //ok
                                                        $res = $stmt->get_result();
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $enrollment->calendar_year . ' ' . $enrollment->calendar_semester; ?></td>
                                                                <td>
