...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->system_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Overall School Timetable.  Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <h4>' . $sys->calendar_semester . ' / ' . $sys->calendar_year . ' Overall School Timetable </h4>
            </h3>
    ...
    $dompdf->render();
    $dompdf->stream($sys->system_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Overall School Timetable', array("Attachment" => 1));
