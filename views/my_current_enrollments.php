                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Currently Enrollments</h4>
                        </div>
                        <hr>
                    </div>
                    <!--end col-->
                            ...
                            <div class="col-lg-12">
                                ...
                                ?>
                                    <div class="card col-md-12 col-xl-12 col-lg-12 col-sm-12">
                                        <a href="my_module_home?view=<?php echo $enrollment->module_id; ?>">
                                            <div class="row g-0">
                                                <div class="col-md-12">
                                                    <div class="card-body">
                                                        <h5 class="card-title"><?php echo $enrollment->module_code . ' ' . $enrollment->module_name; ?></h5>
                                                        <p class="card-text">
                                                            <?php echo $enrollment->module_details; ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
