                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Enrollments Reports</h4>
                            </div>
                            <!--end page-title-box-->
                        </div>
                        <!--end col-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="border border-primary p-2">
                                <legend class="w-auto text-primary font-weight-light">Select Academic Year & Semester To View Module Enrollments</legend>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    ?>
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="text-right">
                                                    <a href="faculty_report_enrollments_export_xls?session=<?php echo $_POST['allocation_calendar_id']; ?>&view=<?php echo $view; ?>" class="btn btn-primary"> <i class="fas fa-file-excel"></i> Export To Excel</a>
                                                    <a href="faculty_report_enrollments_export_pdf?session=<?php echo $_POST['allocation_calendar_id']; ?>&view=<?php echo $view; ?>" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Export To PDF</a>
                                                </div>
                                                <br>
                                                <div class="">
                                                    <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            WHERE e.enrollment_academic_calendar_id  = '$allocation_calendar_id' 
