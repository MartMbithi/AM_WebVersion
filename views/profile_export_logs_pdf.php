...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->user_number . ' ' . $sys->user_name . '   Access Logs. Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <h4> System Access Logs For ' . $sys->user_number . ' ' . $user_name . ' </h4>
            </h3>
    ...
    $dompdf->render();
    $dompdf->stream($sys->system_name . ' ' . $sys->user_number . ' ' . $sys->user_name . ' Access Logs', array("Attachment" => 1));
