...
while ($sys = $res->fetch_object()) {
    ...
    /* Excel File Name */
    $fileName = $sys->system_name . "  " . $sys->calendar_year . ' ' . $sys->calendar_semester . " Teaching Allocations Reports.xls";

    /* Excel Column Name */
    $header = array($sys->system_name . ' ' . $sys->calendar_year  . ' ' . $sys->calendar_semester . ' Module Teaching Allocations');
