                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="enrollment_academic_calendar_id" style="width: 100%;" required class="basic form-control">
                                                ...
                                                ?>
                                                    <option value="<?php echo $cal->calendar_id; ?>"><?php echo $cal->calendar_year . ' ' . $cal->calendar_semester; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        INNER JOIN module_allocations ma ON e.enrollment_module_id = ma.allocation_module_id
                                        INNER JOIN academic_calendar ac ON ac.calendar_id = ma.allocation_calendar_id
                                        INNER JOIN modules m ON m.module_id = ma.allocation_module_id
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post" enctype="multipart/form-data">
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="form-group col-md-6">
                                                                            <label>Academic Calendar</label>
                                                                            <select name="enrollment_academic_calendar_id" style="width: 100%;" required disabled class="basic form-control">
