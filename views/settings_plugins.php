    ...
    <div class="page-wrapper">
        ...
        <div class="page-content-tab">
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Plug Ins</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Plug In</h4>
                        </div>
                    </div>
                    <!--end col-->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <iframe width="100%" height="900" style="border:none;" src="../plugins/file_manager/"></iframe>
                    </div>
                </div>
            </div><!-- container -->
            <!-- Footer -->
