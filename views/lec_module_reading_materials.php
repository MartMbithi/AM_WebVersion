                        ...
                        <div class="">
                            ...
                            ?>
                                <fieldset class="border border-primary p-2">
                                    ...
                                    INNER JOIN modules m ON m.module_id = mrm.material_module_id
                                    INNER JOIN module_allocations a ON a.allocation_module_id = m.module_id
                                    INNER JOIN academic_calendar ac ON ac.calendar_id = a.allocation_calendar_id
                                    WHERE mrm.material_module_id = '$module_id' AND ac.calendar_status = 'Current'
                                    AND a.allocation_user_id = '$user_id'
                                    ORDER BY mrm.material_created_at DESC";
                                    $stmt = $mysqli->prepare($ret);
                                    $stmt->execute(); //ok
                                    $res = $stmt->get_result();
