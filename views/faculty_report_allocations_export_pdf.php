...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->faculty_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Teaching Allocations.  Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <h4>' . $sys->calendar_semester . ' / ' . $sys->calendar_year . ' Teaching Allocations </h4>
            </h3>
            <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
            <thead>
                <tr>
                    <th>Allocated Lecturer </th>
            ...
            while ($allocations = $res->fetch_object()) {
                $html .=
                    '
                        <tr>
                            <td>' . $allocations->user_number . '  ' . $allocations->user_name . '</td>
                            <td>' . $allocations->module_code . '  ' . $allocations->module_name . '</td>
                        </tr>
                        ';
                }
                $html .= '
    ...
    $dompdf->render();
    $dompdf->stream($sys->faculty_name . ' ' . $sys->calendar_semester . ' ' . $sys->calendar_year . ' Teaching Allocations', array("Attachment" => 1));
