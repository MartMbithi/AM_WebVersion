                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Manage Teaching Staffs</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="staff_profile?view=<?php echo $users->user_id; ?>" class="badge badge-success"><i class="fas fa-eye"></i> View</a>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <select type="text" style="width: 100%;" required name="user_access_level" class="basic form-control">
                                                                                        <?php if ($users->user_access_level == 'lecturer') { ?>
