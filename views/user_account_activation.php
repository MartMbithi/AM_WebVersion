...
/* Set New User Account Password */
if (isset($_POST['set_password'])) {
    $new_password = sha1(md5($_POST['new_password']));
    $confirm_password = sha1(md5($_POST['confirm_password']));
    $token = $_GET['token'];
    $user_account_status = 'active';
    /* Get This From Password Reset Link In Your Email */
    ...
    if ($new_password != $confirm_password) {
        ...
        /* Persist */
        $sql = "UPDATE users SET user_password = ?, user_account_status =? WHERE password_reset_token =?";
        $prepare = $mysqli->prepare($sql);
        $bind = $prepare->bind_param('sss', $confirm_password, $user_account_status,  $token);
        $prepare->execute();
        if ($prepare) {
                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    ...
                                    <div class="text-center auth-logo-text">
                                        <h4 class="mt-0 mb-3 mt-5"><?php echo $system_settings->system_name; ?> | Set Your New Account Password </h4>
                                    ...
                                    <form class="form-horizontal auth-form my-4" method="POST">
                                        ...
                                        <div class="form-group mb-0 row">
                                            <div class="col-12 mt-2">
                                                <button class="btn btn-gradient-primary btn-round btn-block waves-effect waves-light" name="set_password" type="submit">
                                                    Set Password
