                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="">Teaching Staff</a></li>
                                    <li class="breadcrumb-item active">Advanced Search Teaching Staffs</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Search Teaching Staffs</h4>
                        </div>
                        <!--end page-title-box-->
                            ...
                            <div class="card-body">
                                <div class="">
                                    <fieldset class="border border-primary p-2">
                                        <legend class="w-auto text-primary font-weight-light">Enter Staff Number Or Name</legend>
                                    ...
                                    <div class="row">
                                        ...
                                        if (strlen($query) >= $min_length) {
                                            ...
                                            $raw_results = mysqli_query(
                                                $mysqli,
                                                "SELECT *  FROM users 
                                                WHERE  user_access_level = 'lecturer' AND
                                        ...
                                        ?>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <a href="staff_profile?view=<?php echo $results['user_id']; ?>">
