...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->system_name . ' Registered Departments List Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            '
                <tr>
                    ...
                    <td>' . $departments->faculty_code . '  ' . $departments->faculty_name . '</td>
    ...
    $dompdf->render();
    $dompdf->stream($sys->system_name . ' Department List ', array("Attachment" => 1));
