                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="std_dashboard">Home</a></li>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-right">
                                                        <a href="my_module_assignment?asn_id=<?php echo $asn->asn_id; ?>&view=<?php echo $_GET['view']; ?>" class="badge badge-primary"><i class="fas fa-eye"></i> View Attempts</a>
                                                    </div>
                                                    </p>
                                                </div>
                                            </div>
