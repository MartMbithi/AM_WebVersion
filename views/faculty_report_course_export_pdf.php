...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->faculty_name . ' Registered Courses List Generated On ' . date('d M Y') . '</i>
            </div>
            ...
            <h3 class="list_header" align="center">
                ...
                <h4> ' . $sys->faculty_name . ' Courses List </h4>
            </h3>
            ...
            '
                <tr>
                    ...
                    <td>' . $courses->department_code . '  ' . $courses->department_name . '</td>
                </tr>
                ';
            }
            $html .= '
    ...
    $dompdf->render();
    $dompdf->stream($sys->faculty_name . ' Courses List ', array("Attachment" => 1));
