...
while ($sys = $res->fetch_object()) {
    ...
    $mail->Subject = 'Teaching Allocation Notification';
    /* Custom Mail Body */
    $mail->Body = '
    <!doctype html>
    <html lang="en-US">
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:"Rubik",sans-serif;">Module Allocation</h1>
                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                Hello ' . $user_details . ', <br>
                                                You have been allocated as the instructor of this module: <br>
                                                <b> ' . $module_details . ' </b><br> 
                                                Proceed to manage and upload module reading materials to your enrolled students. <br>                                             
                                                Thanks, <br>
                                                Kind Regards<br>
